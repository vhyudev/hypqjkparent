...
public class MailUtil {
	...
	public static void sendMessage(String toAddr,String subject,String content) throws Exception{
		...
		//设置发送者
		Address fromAddress = new InternetAddress("18902189863@163.com");//邮件地址
		...
		//火箭连接到服务器上
		transport.connect("smtp.163.com","18902189863@163.com","vhyu123");//密码是邮箱授权码
	...
	public static void main(String[] args) throws Exception {
		sendMessage("2174988802@qq.com","入职提醒","你好帅哥,今晚约么!");
	}
}
