		...
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="printStyle" value="2" ${contract.printStyle=='2'?"checked":"" }  class="input">两款
	            	<input type="radio" name="printStyle" value="1" ${contract.printStyle=='1'?"checked":"" } class="input">一款
	            </td>
	        </tr>		
	        <tr>
	        ...
	        <tr>
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="importNum" value="3" ${contract.importNum==3?"checked":"" } class="input">★★★
	            	<input type="radio" name="importNum" value="2" ${contract.importNum==2?"checked":"" } class="input">★★
	            	<input type="radio" name="importNum" value="1" ${contract.importNum==1?"checked":"" } class="input">★
	            </td>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><textarea name="crequest" style="height:150px;">${contract.crequest }</textarea>
	            <td class="columnTitle">说明：</td>
	            <td class="tableContent"><textarea name="remark" style="height:150px;">${contract.remark }</textarea>
	        </tr>		
		</table>
	</div>
